...
- <strong>&quot;ВКЛЮЧЕНИЕ&quot;</strong> — 7 шагов самостоятельного курса, который изменит вашу жизнь и поможет сразу включиться в активный режим, став частью единой волны с сообществом.
...
def ref_send_if_buy(ref_user_id, first_name, last_name, user_name, mounth, bot_name):
    ...
    count = user_data.sql_get_count_referrals(ref_user_id)
...
Ваш партнер """
    ...
    txt += f"купил подписку на {mounth} месяцев.\n(его имя кликабельное на переписку с ним)\n"
