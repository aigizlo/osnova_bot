...
instruction = """
<b>💎 Вступив в закрытый клуб по подписке</b>
<i>𝐎𝐒𝐍𝐎𝐕𝐀 | 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐥𝐮𝐛</i>
Вы получаете доступ к эксклюзивным методологиям, отточенным за 10 лет тренерского опыта и проверенным на более чем 15 000 участниках.

Клуб “𝐎𝐒𝐍𝐎𝐕𝐀” создан для тех, кто хочет стать мастером своей жизни, перестать быть жертвой, обрести контроль над личными и профессиональными успехами и добиться настоящих изменений.

<b>🔰 Что вас ждёт:</b>
<b>• Поддержка наставников</b> — еженедельные AMA-сессии, разборы участников, практические рекомендации и сопровождение в каждом шаге.  
<b>• Персонализированный план и прогресс-отчёты</b> — вы составите свой путь развития с учётом личных целей, чтобы вы могли фиксировать успехи и продолжать двигаться к лучшей версии себя.  
<b>• Сообщество единомышленников</b> — закрытые чаты для обмена опытом и поддержки, где каждый участник делится знаниями и идёт к успеху вместе с вами.  
<b>• Живые мероприятия и оффлайн-встречи</b> — участвуйте в вебинарах и встречах, где сможете развить навыки и завести новые знакомства.  
<b>• Эксклюзивные курсы и вебинары</b> — уникальные пошаговые материалы, помогающие развивать дисциплину, ответственность, отношения, увеличивать доход и личную мотивацию.  
<b>• Чат контактов для полезных знакомств</b> — здесь вы сможете найти партнёров, наставников и людей, готовых поддержать на любом этапе.  
<b>• Практические задания и челленджи</b> — еженедельные активности, направленные на развитие новых навыков и закрепление пройденного.  
<b>• Уникальные материалы</b> — статьи, виде-оуроки, подкасты, которые помогут вам расширить кругозор и глубже погрузиться в темы личного развития.  
<b>• Бонусы и скидки на новые продукты</b> — получите эксклюзивные предложения на книги, подкасты и курсы, доступные только для членов клуба.  
<b>• Реферальная программа</b> — возможность ежемесячно заработать, помогая другим обрести путь к самосовершенствованию.

<b>🎯 Только от вас зависит, насколько сильной станет ваша новая версия себя. Вступайте в клуб, чтобы уверенно идти к своим целям и обрести поддержку на каждом этапе!</b>

<b>👇🏼 Выбирайте тарифный план и начинайте трансформацию!</b>
"""
