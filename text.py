...
text_expired_sub_7day = """
🔔 Через неделю у вас закончится подписка! 
Не забудьте её продлить по кнопке  ниже 👇🏼 
"""

text_expired_sub_1day = """
🔴 Через 24 часа у вас закончится подписка! 
Не забудьте её продлить по кнопке  ниже 👇🏼 
"""
...
<i>Прошло уже 24 часа, а Вы все еще думаете какую подписку оформить!?
...
text_72_min_notify = """
<b>🤔 Как сказал Бодо Шефер: </b>

<i>Если Вы решили что-то сделать, но не начали это делать в течении 72 минуты  — в 85% случаев Вы не сделаете это никогда!“</i>

"""

text_2_days_notify = """
<b>🤨 Ага, уже пролетело 48 часов! 
...
Выбирайте тариф и за первые 7 дней Вы поймете как избавиться от это проблемы! 
...
<b>"OSNOVA"</b> — это самый быстрый путь к лучшей версии себя.</i>
